...
export const PostGem = ({user_id, setGemsData}) => {
    ...
    function handleSubmit(event) {
        ...
        if (!validPost) {
            ...
            return postGemByUserID(title, description, category, imgUrl, latitude, longitude, address, date, user_id, type)
            .then((gemData) => {
  ...
  // Error Handling
    ...
    return (
        <section>
            ...
            <section>
            {submitted ? <section> <p>You have posted a new Gem!</p> <button onClick={resetForm}>Post a New Gem</button></section> : 
            <form onSubmit={handleSubmit}>
                <label htmlFor="title">Title: </label>
                <input id="title" type="text" name="title" onChange={titleInput} value={title}></input>
                <br></br>

                <label htmlFor="type">Type of Gem: </label>
                <select select name="type" id="type" value={type} onChange={typeInput}>
                ...
                <select name="category" id="category" value={category} onChange={categoryInput}>
                    <option value="" disabled defaultValue>Please select</option>
                ...
                <textarea id="description" type="textarea" name="description" onChange={descriptionInput} value={description}></textarea>
                <br></br>

                {/*will need to be updated by Emily*/}
                <label htmlFor="img_url">Upload an Image</label> 
                <input id="img_url" type="text" name="img_url" value={imgUrl}></input>
                <br></br>
